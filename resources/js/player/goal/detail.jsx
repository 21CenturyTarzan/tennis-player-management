        ...
        <div id="goal">
            <div className="mt-3 py-2 rounded-15 bg-white shadow-lg" style={{minHeight:'700px'}}>
                <h3 className="mt-2 p-1 position-relative text-white bg-green text-center font-weight-bold">
                    ...
                    <span>目標詳細</span>
                    <Link to={`/player/goal/edit/${props.match.params?.id}`}>
                ...
                }
                {
                    ...
                    <>
                        ...
                        <p className="w-100 p-1 pl-2 mb-2 bg-black-4 text-white text-right ft-15">
                            更新日 : {moment(params.updated_at).format('YYYY/MM/DD HH:mm')}<br/>
                            入力日 : {moment(params.created_at).format('YYYY/MM/DD HH:mm')}
                        </p>
                    </>
                }
            </div>
...
export default PlayerGoalDetail;